...
$$
f_{U_1, U_2}(u_1, u_2) = f_{Y_1, Y_2} \left(\frac{u_1}{u_2}, u_2 \right) \frac{1}{|u_2|}.
$$

b) Show that the marginal density function for $U_1$ is

$$
f_{U_1}(u_1) = \int_{-\infty}^{\infty} f_{Y_1, Y_2} \left(\frac{u_1}{u_2}, u_2 \right) \frac{1}{|u_2|} du_2.
$$

c) If $Y_1$ and $Y_2$ are independent, show that the marginal density function for $U_1$ is

$$
f_{U_1}(u_1) = \int_{-\infty}^{\infty} f_{Y_1} \left(\frac{u_1}{u_2} \right) f_{Y_2}(u_2) \frac{1}{|u_2|} du_2.
$$
