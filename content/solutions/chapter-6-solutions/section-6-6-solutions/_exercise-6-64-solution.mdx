...
Let $h: \left(\mathbb{R}^2 - \{(y, -y) \mid y \in \mathbb{R} \} \right) \to \mathbb{R}^2$, where $h(y_1, y_2) = (h_1(y_1, y_2), h_2(y_1, y_2)) = (u_1, u_2) = \left(\frac{y_1}{y_1 + y_2}, y_1 + y_2 \right)$, represent this transformation.
...
We can see $u_1 u_2 = \frac{y_1}{y_1 + y_2} \cdot (y_1 + y_2) = y_1 = h_1^{-1}(u_1, u_2)$ easy enough.
...
Recalling that $y_1 = u_1 u_2$, we then simply have $y_2 - u_2 = -y_1 = -u_1 u_2$.
...
f_{U_1, U_2}(u_1, u_2) =
\begin{cases}
    \frac{u_1^{\alpha_1 - 1} (1 - u_1)^{\alpha_2 - 1} u_2^{\alpha_1 + \alpha_2 - 1} e^{-u_2 / \beta}}{\beta^{\alpha_1 + \alpha_2} \Gamma(\alpha_1) \Gamma(\alpha_2)}, & 0 < u_1 < 1, 0 < u_2,\\
    0, & \text{elsewhere.}
\end{cases}
$$
...
\begin{align*}
    ...
    & =
    \begin{cases}
        \int_{u_2 = 0}^{u_2 = \infty} \frac{u_1^{\alpha_1 - 1} (1 - u_1)^{\alpha_2 - 1} u_2^{\alpha_1 + \alpha_2 - 1} e^{-u_2 / \beta}}{\beta^{\alpha_1 + \alpha_2} \Gamma(\alpha_1) \Gamma(\alpha_2)} du_2\\
        = \frac{u_1^{\alpha_1 - 1} (1 - u_1)^{\alpha_2 - 1}}{\Gamma(\alpha_1) \Gamma(\alpha_2)} \cdot \Gamma(\alpha_1 + \alpha_2) \int_{u_2 = 0}^{u_2 = \infty} \frac{u_2^{\alpha_1 + \alpha_2 - 1} e^{-u_2 / \beta}}{\beta^{\alpha_1 + \alpha_2} \Gamma(\alpha_1 + \alpha_2)} du_2\\
        = \frac{u_1^{\alpha_1 - 1} (1 - u_1)^{\alpha_2 - 1}}{\Gamma(\alpha_1) \Gamma(\alpha_2) / \Gamma(\alpha_1 + \alpha_2)} \cdot 1\\
        = \frac{u_1^{\alpha_1 - 1} (1 - u_1)^{\alpha_2 - 1}}{B(\alpha_1, \alpha_2)}, & 0 < u_1 < 1,\\
        0, & \text{elsewhere.}
    \end{cases}
\end{align*}
$$

This is precisely the density function for a beta distribution with parameters $\alpha_1$ and $\alpha_2$.
...
$$
\begin{align*}
    f_{U_2}(u_2) & = \int_{u_1 = -\infty}^{u_1 = \infty} f_{U_1, U_2}(u_1, u_2) du_1\\
    & =
    \begin{cases}
        \int_{u_1 = 0}^{u_1 = 1} \frac{u_1^{\alpha_1 - 1} (1 - u_1)^{\alpha_2 - 1} u_2^{\alpha_1 + \alpha_2 - 1} e^{-u_2 / \beta}}{\beta^{\alpha_1 + \alpha_2} \Gamma(\alpha_1) \Gamma(\alpha_2)} du_1\\
        = \frac{u_2^{\alpha_1 + \alpha_2 - 1} e^{-u_2 / \beta}}{\beta^{\alpha_1 + \alpha_2} \Gamma(\alpha_1 + \alpha_2)} \int_{u_1 = 0}^{u_1 = 1} \Gamma(\alpha_1 + \alpha_2) \frac{u_1^{\alpha_1 - 1} (1 - u_1)^{\alpha_2 - 1}}{\Gamma(\alpha_1) \Gamma(\alpha_2)} du_1\\
        = \frac{u_2^{\alpha_1 + \alpha_2 - 1} e^{-u_2 / \beta}}{\beta^{\alpha_1 + \alpha_2} \Gamma(\alpha_1 + \alpha_2)} \int_{u_1 = 0}^{u_1 = 1} \frac{u_1^{\alpha_1 - 1} (1 - u_1)^{\alpha_2 - 1}}{B(\alpha_1, \alpha_2)} du_1\\
        = \frac{u_2^{\alpha_1 + \alpha_2 - 1} e^{-u_2 / \beta}}{\beta^{\alpha_1 + \alpha_2} \Gamma(\alpha_1 + \alpha_2)} \cdot 1\\
        = \frac{u_2^{\alpha_1 + \alpha_2 - 1} e^{-u_2 / \beta}}{\beta^{\alpha_1 + \alpha_2} \Gamma(\alpha_1 + \alpha_2)}, & 0 < u_2,\\
        0, & \text{elsewhere.}
    \end{cases}
\end{align*}
$$

This is precisely the density function for a gamma distribution with parameters $\alpha_1 + \alpha_2$ and $\beta$.
